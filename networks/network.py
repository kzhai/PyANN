...
class Network(object):
    ...
    def get_objective(self, label):
        return self._objective_to_minimize(self, label) + self.L1_regularizer() + self.L2_regularizer();
    '''
    ...
    def set_L1_regularizer_lambda(self, L1_regularizer_lambdas=None):
        if type(L1_regularizer_lambdas) == None:
    ...
    def set_L2_regularizer_lambda(self, L2_regularizer_lambdas):
        if type(L2_regularizer_lambdas) == None:
