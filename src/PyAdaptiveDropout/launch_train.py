...
def parse_args():
    ...
    parser.add_option("--input_activation_rate", type="float", dest="input_activation_rate",
...
def launch_train():
    ...
    assert options.input_activation_rate > 0;
    input_activation_rate = options.input_activation_rate;
    ...
    print "input_activation_rate=%s" % (input_activation_rate)
